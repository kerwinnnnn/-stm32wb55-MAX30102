...
{
  /* datasend */
  CUSTOM_STM_DATASEND_READ_EVT,
  CUSTOM_STM_DATASEND_WRITE_EVT,
  CUSTOM_STM_DATASEND_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_DATASEND_NOTIFY_DISABLED_EVT,
  CUSTOM_STM_DATASEND_INDICATE_ENABLED_EVT,
  CUSTOM_STM_DATASEND_INDICATE_DISABLED_EVT,
